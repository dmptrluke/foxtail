...
urlpatterns = [
    ...
    path('manage/<int:year>/<slug:slug>/edit/', views.EventUpdateView.as_view(), name='event_edit'),
    path('manage/<int:year>/<slug:slug>/delete/', views.EventDeleteView.as_view(), name='event_delete'),
